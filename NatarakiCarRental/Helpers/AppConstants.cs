...
public static class AppConstants
{
    ...
    public const string MasterConnectionString = "Server=localhost;Trusted_Connection=True;TrustServerCertificate=True;";
    public const string DefaultConnectionString = "Server=localhost;Database=NatarakiCarRentalDb;Trusted_Connection=True;TrustServerCertificate=True;";
